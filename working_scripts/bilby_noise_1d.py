...
"""
This code computes the posterior distribution for the memory constant ONLY.
Here, we use GWMemory to inject a waveform + memory model into NOISY data.
"""
...
priors["memory_constant"] = bilby.core.prior.Uniform(0, 2, r"$\lambda$")
