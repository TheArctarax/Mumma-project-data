...
fig = figure(figsize=(6, 6))
loglog(frequencies, abs((oscillatory_tilde['plus'][:] + memory_tilde['plus'][:])*np.sqrt(frequencies)), color='r', zorder=1)
loglog(frequencies, abs(oscillatory_tilde['plus']*np.sqrt(frequencies)), color='g', zorder=1)
loglog(frequencies, abs(memory_tilde['plus']*np.sqrt(frequencies)), color='b', zorder=1)
